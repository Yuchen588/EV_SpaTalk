...
- __LRIs and pathways can be download at/[`database/`](https://github.com/ZJUFanLab/SpaTalk/tree/main/data) 
- __Demo data can be download at /[`demo_data/`](https://github.com/ZJUFanLab/SpaTalk/tree/main/inst/extdata)
